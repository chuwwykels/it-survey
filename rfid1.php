...
$page_title = "RFID Method Survey Step 2 ";
...
<body style="background: <?=$rgbaBackGround;?>;">
    ...
    <div class="container py-5">
        <div class="row g-3 justify-content-center">
            ...
            <form id="main_form" action="" method="POST"
                ...
                <!-- Submit -->
                <div class="text-end">
                    <a href="rfid.php" class="btn px-4 btn-no-border"
    ...
    <script>
     swal({
        ...
        button: "Okay!",
        imageUrl: '<?php echo $_SESSION['status_img']; ?>',
        imageWidth: 100, // adjust size
        imageHeight: 100, // square
        imageAlt: 'Logo'
    });
    </script>
    <?php
